CC=			gcc
CXX=		g++
CFLAGS=		-Wall -g -O3 -static -funroll-loops -march=nocona -maccumulate-outgoing-args -fno-stack-protector -msse3
#CFLAGS=		-Wall -g -funroll-loops -march=nocona -maccumulate-outgoing-args -fno-stack-protector -msse3

CXXFLAGS=	$(CFLAGS)
DFLAGS=		#-DHAVE_PTHREAD #-D_NO_SSE2 #-D_FILE_OFFSET_BITS=64	
OBJS =      bwtaln.o bwtgap.o BWT.o BWTConstruct.o utils.o \
            dictionary.o DNACount.o HSP.o iniparser.o \
            inistrlib.o MemManager.o MiscUtilities.o QSufSort.o \
            2BWT-Builder.o TextConverter.o Timing.o bamlite.o \
...
#fastmap.o:BWT.h
BWT.o:	BWT.h TypeNLimit.h MemManager.h TextConverter.h HSP.h MiscUtilities.h DNACount.h r250.h 
...
HSP.o:	TextConverter.h TypeNLimit.h MemManager.h MiscUtilities.h r250.h HSP.h 
